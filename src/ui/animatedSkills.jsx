    ...
    <div className="relative">
      {minorSkills.map((skill) => (
        <div
          ...
          className={`text-[1rem] ${skill.backgroundColor} w-fit min-w-48 p-1 2xl:px-2 rounded-full text-black font-bold absolute flex gap-[0.8rem] text-nowrap items-center cursor-pointer opacity-100 hover:opacity-85 transition-all duration-[2500ms] ease-in-out 2xl:text-xl`}
        >
